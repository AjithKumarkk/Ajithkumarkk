...
![preview](https://i.imgur.com/X1LJy18.png)
...
![search](https://i.imgur.com/IndsapE.png)

<p class="text-center">
  {% include elements/button.html link="https://github.com/AjithKumarkk/Tetris-2D" text="More About Project" %}
</p>
